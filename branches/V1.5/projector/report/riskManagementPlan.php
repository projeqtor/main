...
echo '<tr>';
echo '<td class="largeReportHeader" width="2%">' . i18n('colId') . '</td>';
echo '<td class="largeReportHeader" width="7%">' . i18n('colType') . '</td>';
echo '<td class="largeReportHeader" width="15%">' . i18n('Risk') . '</td>';
echo '<td class="largeReportHeader" width="15%">' . i18n('colCause') . '</td>';
echo '<td class="largeReportHeader" width="15%">' . i18n('colImpact') . '</td>';
echo '<td class="largeReportHeader" width="5%">' . i18n('colSeverityShort') . '</td>';
echo '<td class="largeReportHeader" width="5%">' . i18n('colLikelihoodShort') . '</td>';
echo '<td class="largeReportHeader" width="5%">' . i18n('colCriticalityShort') . '</td>';
echo '<td class="largeReportHeader" width="6%">' . i18n('colResponsible') . '</td>';
echo '<td class="largeReportHeader" width="6%">' . i18n('colDueDate') . '<br/><span style="font-size:75%">' . i18n('commentDueDates') . '</span></td>';
echo '<td class="largeReportHeader" width="6%">' . i18n('colIdStatus') . '</td>';
echo '<td class="largeReportHeader" width="3%">' . i18n('colLink') . '</td>';
echo '<td class="largeReportHeader" width="10%">' . i18n('colResult') . '</td>';
echo '</tr>';
foreach ($lst as $risk) {
  echo '<tr>';
  $done=($risk->done)?'Done':'';
  ...
  echo '<td align="center" class="largeReportData' . $done . '">' . formatColor('Severity', $risk->idSeverity) . '</td>';
  echo '<td align="center" class="largeReportData' . $done . '">' . formatColor('Likelihood', $risk->idLikelihood) . '</td>';
  echo '<td align="center" class="largeReportData' . $done . '">' . formatColor('Criticality', $risk->idCriticality) . '</td>';
  ...
  echo '</table></td>';
  echo '<td align="center" class="largeReportData' . $done . '">' . formatColor('Status', $risk->idStatus) . '</td>';
...
echo '<td class="largeReportHeader" width="2%">' . i18n('colId') . '</td>';
echo '<td class="largeReportHeader" width="7%">' . i18n('colType') . '</td>';
echo '<td class="largeReportHeader" width="17%">' . i18n('Action') . '</td>';
echo '<td class="largeReportHeader" width="17%">' . i18n('colCause') . '</td>';
echo '<td class="largeReportHeader" width="17%">' . i18n('colImpact') . '</td>';
echo '<td class="largeReportHeader" width="5%">' . i18n('colPriority') . '</td>';
echo '<td class="largeReportHeader" width="7%">' . i18n('colResponsible') . '</td>';
echo '<td class="largeReportHeader" width="6%">' . i18n('colDueDate') . '<br/><span style="font-size:75%">' . i18n('commentDueDates') . '</span></td>';
echo '<td class="largeReportHeader" width="7%">' . i18n('colIdStatus') . '</td>';
echo '<td class="largeReportHeader" width="3%">' . i18n('colLink') . '</td>';
echo '<td class="largeReportHeader" width="12%">' . i18n('colResult') . '</td>';
echo '</tr>';
foreach ($lst as $issue) {
  ...
  echo '<td align="center" class="largeReportData' . $done . '">' . formatColor('Priority', $issue->idPriority) . '</td>';
  ...
  echo '</table></td>';
  echo '<td align="center" class="largeReportData' . $done . '">' . formatColor('Status', $issue->idStatus) . '</td>';
...
echo '<td class="largeReportHeader" width="2%">' . i18n('colId') . '</td>';
echo '<td class="largeReportHeader" width="7%">' . i18n('colType') . '</td>';
echo '<td class="largeReportHeader" width="15%">' . i18n('Action') . '</td>';
echo '<td class="largeReportHeader" width="33%">' . i18n('colDescription') . '</td>';
echo '<td class="largeReportHeader" width="5%">' . i18n('colPriority') . '</td>';
echo '<td class="largeReportHeader" width="7%">' . i18n('colResponsible') . '</td>';
echo '<td class="largeReportHeader" width="6%">' . i18n('colDueDate') . '<br/><span style="font-size:75%">' . i18n('commentDueDates') . '</span></td>';
echo '<td class="largeReportHeader" width="7%">' . i18n('colIdStatus') . '</td>';
echo '<td class="largeReportHeader" width="3%">' . i18n('colLink') . '</td>';
echo '<td class="largeReportHeader" width="15%">' . i18n('colResult') . '</td>';
echo '</tr>';
foreach ($lst as $action) {
  ...
  echo '<td align="center" class="largeReportData' . $done . '">' . formatColor('Priority', $action->idPriority) . '</td>';
  ...
  echo '</table></td>';
  echo '<td align="center" class="largeReportData' . $done . '">' . formatColor('Status', $action->idStatus) . '</td>';
...
function formatColor($type, $val) {
  $obj=new $type($val);
  $sp=$obj->sortOrder . '#split#' . $obj->name . '#split#' . $obj->color;
  return colorNameFormatter($sp);
}
