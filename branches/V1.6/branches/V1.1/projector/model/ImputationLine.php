...
class ImputationLine {
  ...
  static function drawLines($resourceId, $rangeType, $rangeValue, $showIdle, $showPlanned=true) {
    ...
    echo '  <TD class="ganttLeftTitle" colspan="' . $nbDays . '" ' 
      . 'style="border-right: 1px solid #ffffff;border-bottom: 1px solid #DDDDDD;"><NOBR>' 
    ...
    echo '  <TD class="ganttLeftTitle" style="width: ' . $nameWidth . 'px;text-align: left; ' 
      . 'border-left:0px; " nowrap><NOBR>' .  i18n('colTask') . '</NOBR></TD>';
    echo '  <TD class="ganttLeftTitle" style="width: ' . $dateWidth . 'px;"><NOBR>' 
      . i18n('colStart') . '</NOBR></TD>';
    echo '  <TD class="ganttLeftTitle" style="width: ' . $dateWidth . 'px;"><NOBR>' 
      . i18n('colEnd') . '</NOBR></TD>';
    echo '  <TD class="ganttLeftTitle" style="width: ' . $workWidth . 'px;"><NOBR>' 
      . i18n('colAssigned') . '</NOBR></TD>';
    echo '  <TD class="ganttLeftTitle" style="width: ' . $workWidth . 'px;"><NOBR>' 
      . i18n('colReal') . '</NOBR></TD>';
    $curDate=$startDate;
    for ($i=1; $i<=$nbDays; $i++) {
      ...
      echo '"><NOBR>';
      if ($rangeType=='week') {
        echo  i18n('colWeekday' . $i) . " "  . date('d',strtotime($curDate)) . '</NOBR>';
      }    
    ...
    echo '  <TD class="ganttLeftTitle" style="width: ' . $workWidth . 'px;"><NOBR>' 
      . i18n('colLeft') . '</NOBR></TD>';
    echo '  <TD class="ganttLeftTitle" style="width: ' . $workWidth . 'px;"><NOBR>' 
      . i18n('colPlanned') . '</NOBR></TD>';
    echo '</TR>';  
