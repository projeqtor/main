...
helpDefaultTheme: "default theme used for connection screen or until user chooses his own",
...
helpLogFile: "log file name (can contain ${date} to have 1 file per day)",
helpLogLevel: "log level",
helpParamAttachementDirectory: "attachments directory",
helpParamAttachementMaxSize: "attachments max size (must be smaller or equal to php parameter : upload_max_filesize)",
helpParamDbDisplayName: "name of the database displayed on the bottom bar of the application",
helpParamDefaultLocale: "defaut language for connexion or until user chooses his own",
...
helpParamLdap_version: "LDAP protocole version (to solve solve compatibility issues)",
helpParamMailTitleDirect: "title of mail when sending manual email through send mail button on item",
helpParamMemoryLimitForPDF: "memory limit for PDF generation (too small can lead to PDF error but too big can crash the server)",
...
helpParamReportTempDirectory: "temporary directory for reports (must be in the web document root to gezt images)",
...
paramParamDefaultLocale: "defaut language",
