...
helpDocumentRoot: "Répertoire racine des documents (ou les versions de documents sont stockées)",
...
helpDefaultTheme: "thème par défaut utilisé pour l'écran de connexion ou tant que l'utilisateur n'a pas sélectionné son thème préféré",
...
helpLogFile: "emplacement et nom du fichier de log (peut contenir ${date} pour avoir 1 fichier par jour)",
helpLogLevel: "niveau de log",
helpParamAttachementDirectory: "répertoire des fichiers attachés",
helpParamAttachementMaxSize: "taille maximum des fichiers attachés (doit être inférieur ou égal au paramètre PHP upload_max_filesize)",
...
helpParamFadeLoadingMode: "mode d'affichage estompé",
...
helpParamMemoryLimitForPDF: "mémoire maximale pour la génération des fichiers PDF (une valeur trop faible fera échouer certaines transformations mais une valeur trop grande peut compromettre la stabilité du serveur)",
...
infoMessage: "Visiter le site Project'Or RIA",
...
menuBarMoveLeft: "déplacer la barre vders la gauche",
menuBarMoveRight: "déplacer la barre vders la droite",
menuBill: "Factures",
...
msgParentRequirementInSameProjectProduct: "l'exigence parente doit apprtenir au même produit ou projet",
msgParentTestCaseInSameProjectProduct: "le cas de test parent doit apprtenir au même produit ou projet",
...
helpParamReportTempDirectory: "répertoire temporaire pour les états (doit être dans le document root web pour afficher les images)",
...
paramParamMemoryLimitForPDF: "mémoire maximale pour la génération des fichiers PDF",
...
passed: "réussi",
passedTestCaseRun: "cas de test passé avec succes",
...
paramParamReportTempDirectory: "répertoire temporaire pour les états",
