...
addPluginFile: "téléverser un fichier d'extension",
...
colOrderReference: "reéférence de la commande",
colOrigin: "origine",
...
confirmInstallPlugin: "Merci de confirmer l'installation de l'extension '${1}'",
...
defaultValue: "défaut",
defineAsFavorit: "définir comme favori",
...
dialogPluginInfo: "description de l'extension",
dialogPrint: "Aperçu",
...
errorSessionHash: "Une anomalie est survenue avec la session actuelle.<br/>Merci de rafraîchir la page ou fermer le navigateur et essayez à nouveau.",
...
featureNotAvailable: "fonctionalité non disponilbe sur cette version",
February: "Février",
...
helpCronImportDirectory: "Répertoire où les fichiers sont recherchés pour les imports automatiques",
...
installPlugin: "installer cette extension",
...
menuPlugin: "Gestion des extensions",
...
moveToDoneStatusFailResult: "impossible de passer au prochain état fait car le resultat n'est pas défini",
...
noPluginAvailable: "aucune extension disponible",
...
PlannedWorkOverAssignedWork: "efforts réévalués comparées aux efforts assignés",
PlannedWorkOverValidatedWork: "efforts réévalués comparées aux efforts validés",
...
Plugin: "Extension",
pluginAlreadyExistsWithCode: "une extension existe déjà avec le code '${1}' et le nom '${2}' différent de '${3}'",
pluginAlreadyExistsWithName: "une extension existe déjà avec le nom '${1}' et le code unique '${2}' différent de '${3}'",
pluginAvailableLocal: "extensions disponibles (localement)",
pluginAvailableRemote: "extensions disponibles (à distance)",
pluginDir: "les extensions (sous forme de fichiers .zip) sont recherchées dans le répertoire '${1}'",
pluginErrorCopy: "Impossible de copier le fichier '${1}' vers le répertoire  '${2}' pour l'extension '${3}'<br>Vérifier la présence du fichier et les droits en écriture sur le répertoire cible.",
pluginErrorMove: "Impossible de supprimer le fichier '${1}' après l'avoir copié pour l'extension '${2}'.<br/>Vérifier les droits d'accès sur ce fichier.",
pluginFileUploaded: "fichier d'extension téléversé",
pluginInstalled: "extensions installées",
pluginNameIncompatibility: "Le nom de l'extension '${1}' est incompatible avec le préfix  '${2}' du nom de fichier '${3}",
pluginNoXmlDescriptor: "impossible de trouver le fichier de description '${1}' dans le répertoire '${2}' pour l'extension '${3}'",
pluginSqlFileError: "Impossible de trouver le fichier Sql '${1}' pour l'extension '${2}'",
...
pluginVersionNotCompatible: "Votre version actuelle ('${1}') n'est pas compatible avec cette extension.<br/>Une version '${2}' ou supérieure est requise",
...
sectionImputationDiary: "Feuille de temps et Agenda",
...
warningIE: "<br/>Vous utilisez Internet Explorer ${1} <br/>ou vous êtes en mode de compatibilité.<br/><br/>Veuillez utiliser IE 8 ou une version plus récente<br/>ou désactiver le mode de compatiblité<br/>ou utiliser un autre navigateur.<br/><br/>",
