...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
        ...
        <table class="page_header">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    HTML2PDF <?php echo defined('__CLASS_HTML2PDF__')? 'v' . __CLASS_HTML2PDF__: 'non-chargé'; ?>
                </td>
            </tr>
        </table>
    </page_header>
    ...
    <h1>HTML2PDF</h1>
    <h3><?php echo defined('__CLASS_HTML2PDF__')? 'v' . __CLASS_HTML2PDF__: 'non-chargé'; ?></h3><br>
    <br><br><br><br><br>
