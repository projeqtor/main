...
pluginErrorCopy: "Impossible de copier le fichier '${1}' vers le répertoire  '${2}' pour le plug-in '${3}'<br>Vérifier la présence du fichier et les droits en écriture sur le répertoire cible.",
...
pluginNoXmlDescriptor: "impossible de trouver le descripteur '${1}' du plug-in '${2}'",
