...
errorSessionHash: "Une anomalie est survenue avec la session actuelle.<br/>Merci de raffraîchir la page ou fermer le navigateur et essayez à nouveau.",
...
planDoneWithLimits: "Des tâches n'ont pas pu être planifiées complètement (affectations insuffisantes) &#58;",
planned: "prévu",
...
startGuideImputation: "Les ressources notent le temps passé sur l’écran des imputations jour par jour et activité par activité.<br/> La réévaluation du « reste à faire » permet d’actualiser le planning avec l’avancement réel.",
startGuideIntro: "Voici une petite page d'aide pour faciliter votre prise en main de ProjeQtOr.<br/>Suivez les quelques étape ci-après pour configurer vos premiers éléments.<br>N'hésitez pas à appuyer sur la touche [F1] à n'importe quel moment pour accéder à l'aide en ligne contextuel.<br/>Pour réafficher cet aide accéder simplement à la page 'Aujourd'hui'.<br/>",
startGuideMilestone: "Les jalons marquent les dates clés du projet.<br/>Ils peuvent définir des entrants (jalons fixes) ou des livrables (jalons flotants)",
startGuidePlanning: "Le planning propose une vue de type diagramme de Gantt.<br/>Pour planifier les activités il faut commencer par assigner les ressources aux activités en définissant la charge de travail prévue car le planning est « piloté par les charges ».<br/>Ensuite vous définissez les relations entre les tâches (liens de précédence) et avec les jalons...<br/>Vous pouvez alors lancer le calcul du planning qui prend en compte la disponibilité des ressources et les contraintes.",
...
startGuideResource: "Les ressource sont les personnes qui vont travailler sur les tâches que vous allez définir.<br/>En cochant « est un utilisateur » la ressource pourra se connecter à l’application.",
