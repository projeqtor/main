...
$forumHeader = $this->params->get('forumHeadercolor', $skinner ? '' : '#555382');
...
$forumLink = $this->params->get('forumLinkcolor', $skinner ? '' : '#555382');
...
$announcementHeader = $this->params->get('announcementHeadercolor', $skinner ? '' : '#555382');
...
$frontStatsHeader = $this->params->get('frontstatsHeadercolor', $skinner ? '' : '#555382');
...
$onlineHeader = $this->params->get('whoisonlineHeadercolor', $skinner ? '' : '#555382');
...
$activeTab = $this->params->get('activeTabcolor', $skinner ? '' : '#555382');
...
$hoverTab = $this->params->get('hoverTabcolor', $skinner ? '' : '#555382');
...
$topBorder = $this->params->get('topBordercolor', $skinner ? '' : '#555382');
...
$toggleButton = $this->params->get('toggleButtoncolor', $skinner ? '' : '#555382');
