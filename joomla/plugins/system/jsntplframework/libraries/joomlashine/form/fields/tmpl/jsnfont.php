...
<div class="control-group">
	...
	<div class="controls">
		<select id="<?php echo "{$this->id}_style"; ?>" name="<?php echo $this->name ?>[style]" autocomplete="off">
	...
	<div class="control-group">
		...
		<div class="controls">
			<div class="input-append">
				<input class="input-mini" id="<?php echo "{$this->id}_{$style}_size"; ?>" name="<?php echo $this->name ?>[<?php echo $style; ?>][size]" type="number" value="<?php echo (int) @$this->value[$style]['size']; ?>" />
