...
<form id="finder-search" action="<?php echo JRoute::_($this->query->toURI()); ?>" method="get">
	...
	<fieldset class="word">
		...
		<?php if ($this->escape($this->query->input) != '' || $this->params->get('allow_empty_search')):?>
			<button name="Search" type="submit" class="button btn"><?php echo JText::_('JSEARCH_FILTER_SUBMIT');?></button>
		<?php else: ?>
			<button name="Search" type="" class="button btn"><?php echo JText::_('JSEARCH_FILTER_SUBMIT');?></button>
		<?php endif; ?>
</fieldset>
