...
$content = new ArtxContent($this, $this->params);
echo $content->beginPageContainer('archive');
?>
...
<?php
echo artxPost(array('header-text' => $content->pageHeading, 'content' => ob_get_clean()));
echo $this->loadTemplate('items');
?>
</form>
<?php
echo $content->endPageContainer();
