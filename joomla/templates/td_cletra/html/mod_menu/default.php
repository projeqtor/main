...
if (isset($attribs['name']) && $attribs['name'] == 'mainmenu') {
    $menutype = 'horizontal';
    ...
    echo '</ul>';
} else if (0 === strpos($params->get('moduleclass_sfx'), 'td-vmenu') || false !== strpos($params->get('moduleclass_sfx'), ' td-vmenu')) {
    $menutype = 'vertical';
