...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'td-nostyle';
  $styles = array(
    'td-nostyle' => 'modChrome_artnostyle',
    'td-block' => 'modChrome_artblock',
    'td-article' => 'modChrome_artarticle',
    'td-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'td-...'        - overwrites module style.
  //  'td-... suffix' - overwrites style and adds suffix to the module root tag and
  //                     to the module elements, does not add td-... to the module elements.
  $classes = '';
...
<div class="td-nostyle<?php echo $params->get('artx-module-classes'); ?>">
