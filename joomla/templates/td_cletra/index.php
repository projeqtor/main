...
<?PHP }?>
		...
		<?php if ($view->containsModules('right')) : ?>
			<div class="td-layout-cell td-sidebar1" style="position: absolute; top:0px; right:0px; width: 240px; z-index:0;">
	...
	<?php if($templateparams->get('show-header',1)) :?>
		...
		<?php   if (JRequest::getVar('view') == 'featured') : ?>
			<div class="td-header" style="z-index:-1">
			    <div id="imageslider" width="100%" height="200px" style="height:250px;"></div>
...
<div id="logo">
<a href="index.php"><img src="<?php echo $templateUrl; ?>/images/logo.png" alt="" height="230px"/></a>
</div>
<!-- TEXT -->
<?php     else: ?>
<div class="td-logo">
