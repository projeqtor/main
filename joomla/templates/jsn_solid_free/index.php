...
<div id="jsn-master_inner">
	...
	?>
		<div id="jsn-header">
			<div id="jsn-logo" class="<?php echo ($this->direction == 'ltr')?'pull-left':'pull-right'; ?>">
			<?php
			...
			<div id="jsn-headerright" class="<?php echo ($this->direction == 'ltr')?'pull-right':'pull-left'; ?>">
			<?php
				/*====== Show modules in position "top" ======*/
				if ($jsnutils->countModules('top') > 0) {
			?>
				<div id="jsn-pos-top" class="<?php echo ($this->direction == 'ltr')?'pull-left':'pull-right'; ?>">
