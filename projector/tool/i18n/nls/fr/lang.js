...
paramParamMailBodyUser: "cops de mail à l'utilisateur",
...
anyValueToImput: "Il ne vous reste plus d'heure de travail à imputer.",
checkAllValuesImputed: "Veuillez imputer tous vos jours avant de valider.",
helpRealWorkOnlyForResponsible: "Seul le responsable peut entrer du travail réel sur un ticket",
imputationCapacityError: "Il ne vous reste pas assez d'heures aujourd'hui pour valider tous votre travail. Veuillez choisir un autre jour en plus.",
imputationTodayQuestion: "Souhaitez vous imputer pour aujourd'hui?",
paramRealWorkOnlyForResponsible: "Seul le responsable entre du travail réel",
successValuesImputed: "Tous vos jours ont été validé avec succès",
ticketRealWorkErrResponsible: "Seul le responsable peut entrer du travail réel sur un ticket",
workElementRealWorkErrDiffValNeg: "Vous ne pouvez entrer un travail réel inférieur au précédent.",
workElementRealWorkErrNotCreated: "Veuillez enregistrer le nouveau ticket avant d'entrer un travail réel.",
