...
$version="V1.0.1";            // Version of application : Major / Minor / Release
$build="0017";                // Build number. To be increased on each release
$website="http://projector.toolware.fr"; // ProjectOr site url
