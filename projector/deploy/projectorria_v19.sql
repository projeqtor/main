...
--
-- Serveur: localhost
-- Généré le : Dim 11 Décembre 2011 à 16:10
...
--
-- Base de données: `projectorria_v20`
--
...
(344, 'Activity', 1, 'update', 'reference', NULL, '001-001-1-TAS-1', '2011-12-11 16:09:36', NULL),
(345, 'Activity', 2, 'update', 'reference', NULL, '001-001-2-EVO-1', '2011-12-11 16:09:36', NULL),
(346, 'Activity', 3, 'update', 'reference', NULL, '001-001-2-TAS-1', '2011-12-11 16:09:36', NULL),
(347, 'Activity', 4, 'update', 'reference', NULL, '001-001-2-TAS-2', '2011-12-11 16:09:36', NULL),
(348, 'Activity', 5, 'update', 'reference', NULL, '001-001-2-TAS-3', '2011-12-11 16:09:37', NULL),
(349, 'Activity', 6, 'update', 'reference', NULL, '001-001-2-EVO-2', '2011-12-11 16:09:37', NULL),
(350, 'Milestone', 1, 'update', 'reference', NULL, '001-001-2-KEY-1', '2011-12-11 16:09:37', NULL),
(351, 'Ticket', 1, 'update', 'reference', NULL, '001-001-INC-1', '2011-12-11 16:09:37', NULL);
...
INSERT INTO `project` (`id`, `name`, `description`, `idClient`, `projectCode`, `contractCode`, `color`, `idProject`, `idle`, `idUser`, `done`, `idleDate`, `doneDate`, `idContact`, `sortOrder`, `idProjectType`, `codeType`) VALUES
(1, 'project one', '1st project\nThis project has 2 sub-projects', 1, '001-001', 'X23-472-722', '#6a5acd', NULL, 0, 5, 0, NULL, NULL, NULL, '001', NULL, 'OPE'),
(2, 'project one - maintenance', 'This project is dedicated to maintenance of ''''web application'''' V1.0\nIt is sub-project of project one.', 1, '001-001-1', 'X23-472-722', '#6495ed', 1, 0, 5, 0, NULL, NULL, NULL, '001.001', NULL, 'OPE'),
(3, 'project one - developement', 'This project is dedicated to developement of ''''web application'''' V2.0\nIt is sub-project of project one.', 1, '001-001-2', 'X23-472-722', '#87ceeb', 1, 0, 5, 0, NULL, NULL, NULL, '001.002', NULL, 'OPE'),
(4, 'project two', '1st project\nThis project has 2 sub-projects', 2, '002-002', 'X24-001-007', '#b22222', NULL, 0, 6, 0, NULL, NULL, NULL, '002', NULL, 'OPE'),
(5, 'internal project', 'internal project\nout of project work', 3, NULL, NULL, '#008b8b', NULL, 0, 1, 0, NULL, NULL, NULL, '003', NULL, 'OPE'),
(6, 'holidays', 'holidays', 3, NULL, NULL, '#20b2aa', 5, 0, NULL, 0, NULL, NULL, NULL, '003.001', NULL, 'OPE');
...
INSERT INTO `ticket` (`id`, `idProject`, `idTicketType`, `name`, `description`, `creationDateTime`, `idUser`, `initialDueDateTime`, `idStatus`, `idResource`, `actualDueDateTime`, `idleDateTime`, `result`, `comment`, `idle`, `idActivity`, `idCriticality`, `idUrgency`, `idPriority`, `done`, `doneDateTime`, `handled`, `handledDateTime`, `idContact`, `idVersion`, `idOriginalVersion`, `reference`, `externalReference`) VALUES
(1, 1, 16, 'bug: it does not work', NULL, '2011-09-01 12:00:00', 1, '2011-09-02 18:00:00', 3, 3, '2011-09-09 18:30:00', NULL, NULL, NULL, 0, NULL, 1, 2, 1, 0, NULL, 1, '2011-09-02 01:54:00', NULL, NULL, 1, '001-001-INC-1', NULL);
...
CREATE TABLE IF NOT EXISTS `type` (
  ...
  `internalData` varchar(100) DEFAULT NULL,
  `code` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `typeScope` (`scope`)
...
(48, 'Project', 'Fixed Price', 10, 0, NULL, NULL, 0, 0, 0, 0, 0, 0, 'E', 'OPE'),
(49, 'Project', 'Time & Materials', 20, 0, NULL, NULL, 0, 0, 0, 0, 0, 0, 'R', 'OPE'),
(50, 'Project', 'Capped Time & Materials', 30, 0, NULL, NULL, 0, 0, 0, 0, 0, 0, 'P', 'OPE'),
(51, 'Project', 'Internal', 40, 0, NULL, NULL, 0, 0, 0, 0, 0, 0, 'N', 'OPE'),
(52, 'Project', 'Administrative', 80, 0, NULL, NULL, 0, 0, 0, 0, 0, 0, 'N', 'ADM'),
(53, 'Project', 'Template', 90, 0, NULL, NULL, 0, 0, 0, 0, 0, 0, 'N', 'TMP');
...
INSERT INTO `user` (`id`, `name`, `fullName`, `email`, `description`, `password`, `idProfile`, `isResource`, `isUser`, `locked`, `idle`, `phone`, `mobile`, `fax`, `idTeam`, `capacity`, `address`, `isContact`, `idClient`, `idRole`, `isLdap`, `initials`) VALUES
(1, 'admin', NULL, NULL, NULL, '21232f297a57a5a743894a0e4a801fc3', 1, 0, 1, 0, 0, NULL, NULL, NULL, NULL, '1.00', NULL, 0, NULL, NULL, 0, NULL),
(2, 'guest', NULL, NULL, NULL, '084e0343a0486ff05530df6c705c8bb4', 5, 0, 1, 0, 0, NULL, NULL, NULL, NULL, '1.00', NULL, 0, NULL, NULL, 0, NULL),
(3, 'manager1', 'project manager', 'project.manager@toolware.fr', NULL, '6d361b76b20af1a3ebbf75a00b501766', 3, 1, 1, 0, 0, NULL, NULL, NULL, 1, '1.00', NULL, 0, NULL, 1, 0, NULL),
(4, 'member1', 'analyst A', NULL, NULL, NULL, 4, 1, 1, 0, 0, NULL, NULL, NULL, 1, '1.00', NULL, 0, NULL, 2, 0, NULL),
(5, 'external1', 'external project leader one', NULL, NULL, NULL, 6, 0, 1, 0, 0, NULL, NULL, NULL, NULL, '1.00', NULL, 1, 1, NULL, 0, NULL),
(6, 'external2', 'external project leader two', NULL, NULL, NULL, 6, 0, 1, 0, 0, NULL, NULL, NULL, NULL, '1.00', NULL, 1, 2, NULL, 0, NULL),
(7, NULL, 'external business leader one', NULL, NULL, NULL, 5, 0, 0, 0, 0, NULL, NULL, NULL, NULL, '1.00', NULL, 1, 1, NULL, 0, NULL),
(8, 'member2', 'analyst B', NULL, NULL, NULL, 4, 1, 1, 0, 0, NULL, NULL, NULL, 1, '1.00', NULL, 0, NULL, 2, 0, NULL),
(9, 'member3', 'analyst C', NULL, NULL, NULL, 4, 1, 1, 0, 0, NULL, NULL, NULL, 2, '1.00', NULL, 0, NULL, 2, 0, NULL),
(10, NULL, 'web developer', NULL, NULL, NULL, 4, 1, 0, 0, 0, NULL, NULL, NULL, 1, '5.00', NULL, 0, NULL, 3, 0, NULL),
(11, NULL, 'swing developer', NULL, NULL, NULL, 4, 1, 0, 0, 0, NULL, NULL, NULL, 2, '5.00', NULL, 0, NULL, 3, 0, NULL),
(12, NULL, 'multi developer', NULL, NULL, NULL, 4, 1, 0, 0, 0, NULL, NULL, NULL, NULL, '5.00', NULL, 0, NULL, 3, 0, NULL);
