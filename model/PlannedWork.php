...
//echo "<br/>******************************";
debugLog ("plan for projet=" . $projectId . " at date=" . $startDate);
    ...
    $inClause="idProject in ('" . $proj->id . "'";
    $listProj=$proj->getRecursiveSubProjectsFlatList(true);
    foreach ($listProj as $id=>$name) {
      $inClause.=", '" . $id . "'"; 
    }
    $inClause.=")";
